...
def parse_arguments():
    ...
    parser.add_argument("-r", "--replace",nargs=2, metavar=("TARGET", "REPLACEMENT"), action="store_true", help="Replace a string of character with another string of characters across all layers.")
    ...
    parser.add_argument("-fd", "--fixduplicate", action="store_true", help="Fix duplicate layer names by appending a number. (eg. 'Layer_1')")
